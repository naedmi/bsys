...
``` sh
┌──(nada㉿DESKTOP-FDK1TG0)-[~/ostep-homework/cpu-sched]
...
when the lengths of the jobs arriving in the system is in ascending order or the same length

5. **For what types of workloads and quantum lengths does SJF deliver the same response times as RR?**

quantum length is the same as the length of the jobs

6. **What happens to response time with SJF as job lengths increase? Can you use the simulator to demonstrate the trend?**

higher job length -> longer response time

```sh
┌──(nada㉿DESKTOP-FDK1TG0)-[~/ostep-homework/cpu-sched]
└─$ ./scheduler.py -p SJF -l 50,50,50 -c
ARG policy SJF
ARG jlist 50,50,50
...
Execution trace:
  ...
  [ time  50 ] Run job 1 for 50.00 secs ( DONE at 100.00 )
  [ time 100 ] Run job 2 for 50.00 secs ( DONE at 150.00 )

Final statistics:
  Job   0 -- Response: 0.00  Turnaround 50.00  Wait 0.00
  Job   1 -- Response: 50.00  Turnaround 100.00  Wait 50.00
  Job   2 -- Response: 100.00  Turnaround 150.00  Wait 100.00

  Average -- Response: 50.00  Turnaround 100.00  Wait 50.00
  
┌──(nada㉿DESKTOP-FDK1TG0)-[~/ostep-homework/cpu-sched]
└─$ ./scheduler.py -p SJF -l 60,60,60 -c
ARG policy SJF
ARG jlist 60,60,60
...
Execution trace:
  ...
  [ time  60 ] Run job 1 for 60.00 secs ( DONE at 120.00 )
  [ time 120 ] Run job 2 for 60.00 secs ( DONE at 180.00 )

Final statistics:
  Job   0 -- Response: 0.00  Turnaround 60.00  Wait 0.00
  Job   1 -- Response: 60.00  Turnaround 120.00  Wait 60.00
  Job   2 -- Response: 120.00  Turnaround 180.00  Wait 120.00

  Average -- Response: 60.00  Turnaround 120.00  Wait 60.00
...
quantum length increases -> higher response time
(n-1)*quantum length (response time vom n. job) / 2
